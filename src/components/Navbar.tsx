...
function Navbar() {
  return (
    <header className="w-full flex justify-center absolute top-[30px] z-10">
      <nav className="w-full max-w-[1360px] h-[80px] bg-white py-2 px-5 md:px-10 shadow-md rounded-[80px] flex justify-between items-center">
        ...
        <button className="text-black font-semibold py-2 px-4 text-[16px] w-auto md:w-[164px] h-[53px] bg-gradient-to-b from-[#4DD969] to-[#28CD56] rounded-[30px] hover:opacity-90 transition-opacity focus:outline-none focus:ring-2 focus:ring-[#28CD56] focus:ring-opacity-50">
